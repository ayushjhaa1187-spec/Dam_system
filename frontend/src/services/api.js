  ...
  runSimulation: async (params) => {
    ...
    try {
      ...
      const calcParams = {
        ...
        reservoir_level_pct: params.reservoir_level_pct || params.breach_params?.reservoir_level_pct || params.custom_params?.reservoir_level_pct || 95,
        breach_width_m:      params.breach_width_m      || params.breach_params?.breach_width_m      || params.custom_params?.breach_width_m      || 90,
        formation_time_hr:   params.formation_time_hr   || params.breach_params?.formation_time_hrs  || params.custom_params?.formation_time_hr   || 1.5,
        manning_n:           params.manning_n            || params.hydraulic_params?.manning_n        || params.custom_params?.manning_n            || 0.042,

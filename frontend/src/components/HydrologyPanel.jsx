      ...
      <div className="bg-hc-surface border border-hc-border rounded-xl p-6 shadow-xl flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="bg-hc-success/10 text-hc-success border border-emerald-500/20 text-xs font-medium px-2 py-0.5 rounded-full">
        ...
        <div className="bg-hc-surface border border-hc-border rounded-xl p-5 shadow-xl space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-hc-bg border border-hc-border rounded-lg px-3 py-2 text-sm text-sky-400 font-mono focus:outline-none focus:border-sky-500"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-hc-bg border border-hc-border rounded-lg px-3 py-2 text-sm text-amber-400 font-mono focus:outline-none focus:border-sky-500"
            />
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-hc-bg border border-hc-border rounded-lg px-3 py-2 text-sm text-hc-ink font-mono focus:outline-none focus:border-sky-500"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-hc-bg border border-hc-border rounded-lg px-3 py-2 text-sm text-indigo-400 font-mono focus:outline-none focus:border-sky-500"
            />
            <span className="text-[11px] text-hc-textSecondary mt-1 block">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="bg-hc-surface border border-hc-border rounded-xl p-4">
                <span className="text-xs text-hc-textSecondary block">Direct Runoff Depth (Pe)</span>
              ...
              <div className="bg-hc-surface border border-hc-border rounded-xl p-4">
                <span className="text-xs text-hc-textSecondary block">Total Runoff Volume</span>
              ...
              <div className="bg-hc-surface border border-hc-border rounded-xl p-4">
                <span className="text-xs text-hc-textSecondary block">Peak Inflow Discharge</span>
                <span className="text-xl font-bold text-hc-success font-mono mt-1 block">
              ...
              <div className="bg-hc-surface border border-hc-border rounded-xl p-4">
                <span className="text-xs text-hc-textSecondary block">Max Reservoir Elevation</span>
                <span className={`text-xl font-bold font-mono mt-1 block ${result.summary?.overtopping_risk ? 'text-hc-critical' : 'text-amber-400'}`}>
            ...
            <div className="bg-hc-surface border border-hc-border rounded-xl p-5 shadow-xl">
              <h2 className="text-sm font-semibold text-hc-ink mb-4 flex items-center justify-between">
                <span>📈 Catchment Inflow Hydrograph Q_in(t)</span>
                <span className="text-xs font-mono text-hc-textSecondary bg-hc-bg px-2 py-1 rounded border border-hc-border">
                  Peak: {result.peak_inflow_discharge_m3s ?? result.peak_inflow_m3s ?? 0} m³/s
                </span>
              </h2>

              <div className="h-64 flex items-end gap-1 border-b border-hc-border pb-2">
                {(result.inflow_hydrograph_m3s || []).map((flow, i) => {
                  ...
                  return (
                    ...
                    >
                      <div className="opacity-0 group-hover:opacity-100 absolute bottom-full mb-1 left-1/2 -translate-x-1/2 bg-hc-bg border border-hc-border text-sky-400 text-[10px] font-mono px-2 py-1 rounded whitespace-nowrap z-20 pointer-events-none">
              ...
              <div className="flex justify-between text-[11px] text-hc-textSecondary font-mono mt-2">
                <span>0 hrs</span>
